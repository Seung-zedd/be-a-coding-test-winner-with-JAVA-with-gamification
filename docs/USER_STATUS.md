...
> "두 뭉치의 카드가 섞이지 않고 각자의 길을 걷되, 오직 `goal`이라는 목적지에서만 만나는 큐의 절제미를 보았다. '카드를 넘길 수 없다'는 제약은 곧 '지금 당장 정답이 아니면 실패'라는 단호한 논리로 치환되었다. 1씩 감소하는 `answer`가 마침내 0에 도달했을 때, 전장의 안개는 완전히 걷혔다."
